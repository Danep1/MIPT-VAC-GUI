...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.delay_spin.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.delay_label.sizePolicy().hasHeightForWidth())
        self.delay_label.setSizePolicy(sizePolicy4)
        font = QFont()
        ...
        sizePolicy3.setHeightForWidth(self.step_spin.sizePolicy().hasHeightForWidth())
        self.step_spin.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.limit_right_label.sizePolicy().hasHeightForWidth())
        self.limit_right_label.setSizePolicy(sizePolicy4)
        self.limit_right_label.setFont(font)
        ...
        sizePolicy4.setHeightForWidth(self.limit_left_label.sizePolicy().hasHeightForWidth())
        self.limit_left_label.setSizePolicy(sizePolicy4)
        self.limit_left_label.setFont(font)
        ...
        sizePolicy3.setHeightForWidth(self.limit_left_spin.sizePolicy().hasHeightForWidth())
        self.limit_left_spin.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.step_label.sizePolicy().hasHeightForWidth())
        self.step_label.setSizePolicy(sizePolicy4)
        ...
        sizePolicy3.setHeightForWidth(self.limit_right_spin.sizePolicy().hasHeightForWidth())
        self.limit_right_spin.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.limit_left_accurate_label.sizePolicy().hasHeightForWidth())
        self.limit_left_accurate_label.setSizePolicy(sizePolicy4)
        font1 = QFont()
        font1.setFamilies([u"Ubuntu Condensed"])
        font1.setStyleStrategy(QFont.PreferDefault)
        self.limit_left_accurate_label.setFont(font1)
        ...
        sizePolicy4.setHeightForWidth(self.delay_accurate_label.sizePolicy().hasHeightForWidth())
        self.delay_accurate_label.setSizePolicy(sizePolicy4)
        self.delay_accurate_label.setFont(font1)
        ...
        sizePolicy4.setHeightForWidth(self.limit_right_accurate_label.sizePolicy().hasHeightForWidth())
        self.limit_right_accurate_label.setSizePolicy(sizePolicy4)
        self.limit_right_accurate_label.setFont(font1)
        self.limit_right_accurate_label.setStyleSheet(u"padding-right: 1px")
        ...
        sizePolicy3.setHeightForWidth(self.limit_left_accurate_spin.sizePolicy().hasHeightForWidth())
        self.limit_left_accurate_spin.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.delay_accurate_spin.sizePolicy().hasHeightForWidth())
        self.delay_accurate_spin.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.limit_right_accurate_spin.sizePolicy().hasHeightForWidth())
        self.limit_right_accurate_spin.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.step_accurate_spin.sizePolicy().hasHeightForWidth())
        self.step_accurate_spin.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.step_accurate_label.sizePolicy().hasHeightForWidth())
        self.step_accurate_label.setSizePolicy(sizePolicy4)
        self.step_accurate_label.setFont(font1)
        ...
        sizePolicy4.setHeightForWidth(self.meas_control_box.sizePolicy().hasHeightForWidth())
        self.meas_control_box.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.manual_panel_box.sizePolicy().hasHeightForWidth())
        self.manual_panel_box.setSizePolicy(sizePolicy4)
